...
# Most of the code here is the same as the original stretch_driver,
# with the key difference being that the remappings have been changed
# to fit those needed for Seeing-Eye, and moved inside this package
...
def generate_launch_description():
    ...
    stretch_urdf_path = str(get_package_share_path('stretch_description') / 'urdf' / 'stretch.urdf')
    robot_description_content = launch_ros.parameter_descriptions.ParameterValue(Command(['xacro ', stretch_urdf_path]), value_type=str)
    ...
    stretch_driver = Node(package='stretch_core',
                          ...
                          emulate_tty=True,
                          output='screen',
                          remappings=[('cmd_vel', '/seeing_eye/cmd_vel'),
                                      ('odom', '/seeing_eye/odom'),
